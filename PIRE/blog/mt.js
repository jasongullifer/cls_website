...
var mtCookieDomain = ".cls.psu.edu";
var mtCookiePath = "/";
...
(function () {
  ...
  function _initializeVariables() {
    ...
    loadingIcon = "<img title='Loading...' src='https://blogs.psu.edu/mt4/mt-static/images/indicator.white.gif' alt='Loading' />";
  ...
  function _updateComments() {
    ...
    jsonUrl = [
        "https://blogs.psu.edu/mt4/mt-comments.cgi?__mode=comment_listing&direction=",
        direction,
        "&entry_id=",
        entryID,
        "&limit=",
...
function mtFetchUser(cb) {
    ...
    if ( ( cb == 'mtSetUser' ) && mtGetUser() ) {
        ...
        script.src = 'https://blogs.psu.edu/mt4/mt-comments.cgi?__mode=session_js&blog_id=34640&jsonp=' + cb + '&ts=' + ts;
...
function mtCommentOnSubmit(f) {
    if (!mtRequestSubmitted) {
        ...
        if (f.armor)
            f.armor.value = '6a88552b71c89b6660cc2ab88b85b7a346d6e45d';
...
function mtUserOnLoad() {
	...
	// begin added by TK
	// only get comment subscriptions if the function is defined (it's only defined in the post page that accepts comments)
	if (typeof window.getCommentSubscriptions == 'function') {
...
function mtSignIn() {
    ...
    var url = 'https://blogs.psu.edu/mt4/mt-comments.cgi?__mode=login&blog_id=34640';
    if (is_preview) {
        if ( document['comments_form'] ) {
            var entry_id = document['comments_form'].entry_id.value;
            url += '&entry_id=' + entry_id;
        } else {
            url += '&return_url=http%3A%2F%2Fcls.psu.edu%2FPIRE%2Fblog%2F';
        }
    } else {
...
function mtSignOut(entry_id) {
    ...
    var doc_url = document.URL;
    doc_url = doc_url.replace(/#.+/, '');
    var url = 'https://blogs.psu.edu/mt4/mt-comments.cgi?__mode=handle_sign_in&static=0&logout=1';
    if (is_preview) {
        if ( document['comments_form'] ) {
            var entry_id = document['comments_form'].entry_id.value;
            url += '&entry_id=' + entry_id;
...
function mtShowGreeting() {
    ...
    if ( u && u.is_authenticated ) {
        if ( u.is_banned ) {
            ...
            var user_link;
            if ( u.is_author ) {
                user_link = '<a href="https://blogs.psu.edu/mt4/mt-comments.cgi?__mode=edit_profile&return_url=' + encodeURIComponent( location.href );
                user_link += '">' + u.name + '</a>';
            } else {
